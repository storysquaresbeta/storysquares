...
class Tasks_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        //added by GS
        $task_block_table = $this->db->dbprefix('task_blocks');
        ...
        $join_custom_fieds = get_array_value($custom_field_query_info, "join_string");
         ...
         //edited by GS
        $sql = "SELECT $tasks_table.*, $task_status_table.key_name AS status_key_name, $task_status_table.title AS status_title, $task_block_table.color as blockcolor,  $task_status_table.color AS status_color, CONCAT($users_table.first_name, ' ',$users_table.last_name) AS assigned_to_user, $users_table.image as assigned_to_avatar, 
        ...
        LEFT JOIN $task_block_table ON $tasks_table.task_block_id = $task_block_table.id 
        $extra_left_join
        $join_custom_fieds    
