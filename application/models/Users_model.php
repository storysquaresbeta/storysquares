...
class Users_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $role_type = get_array_value($options, "role_type");
        ...
        //added by GS
        if($role_type == 'classadmin'){
            $where .= " AND $roles_table.role_type='student'";
        }
 ...
 //edited by GS
        ...
        $sql = "SELECT $users_table.*, $roles_table.role_type, 
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin, $users_table.role_id, $users_table.email,
            ...
            $roles_table.title as role_title, $roles_table.permissions,  $roles_table.role_type, 
