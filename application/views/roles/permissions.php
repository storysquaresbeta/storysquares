        ...
        <div class="panel-body">
            ...
            <ul class="permission-list">
                <li>
                    ...
                    <?php //Added by GS ?>
                    <?php //statically only allow the classroom admin group to add members. Only admin can add members by default ?>
                    <?php if($model_info->role_type == 'classadmin') { ?>
                    <div>
                        <?php
                        echo form_checkbox("can_create_members", "1", $can_create_members ? true : false, "id='can_create_members'");
                        ?>
                        <label for="can_create_members"><?php echo lang("can_create_members"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_edit_members", "1", $can_edit_members ? true : false, "id='can_edit_members'");
                        ?>
                        <label for="can_edit_members"><?php echo lang("can_edit_members"); ?></label>
                    </div>
                    <?php } ?>
                     <?php //Added by GS ?>
                    <div>
                        <?php
                        echo form_checkbox("can_create_task_blocks", "1", $can_create_task_blocks ? true : false, "id='can_create_task_blocks'");
                        ?>
                        <label for="can_create_task_blocks"><?php echo lang("can_create_task_blocks"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_edit_task_blocks", "1", $can_edit_task_blocks ? true : false, "id='can_edit_task_blocks'");
                        ?>
                        <label for="can_edit_task_blocks"><?php echo lang("can_edit_task_blocks"); ?></label>
                    </div>
                    <div>
                        <?php
                        echo form_checkbox("can_delete_task_blocks", "1", $can_edit_task_blocks ? true : false, "id='can_delete_task_blocks'");
                        ?>
                        <label for="can_delete_task_blocks"><?php echo lang("can_delete_task_blocks"); ?></label>
                    </div>
                    <div>
                        <?php
