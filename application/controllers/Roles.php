...
class roles extends MY_Controller {
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            //Added by GS
            $view_data['can_create_task_blocks'] = get_array_value($permissions, "can_create_task_blocks");
            $view_data['can_edit_task_blocks'] = get_array_value($permissions, "can_edit_task_blocks");
            $view_data['can_delete_task_blocks'] = get_array_value($permissions, "can_delete_task_blocks");
            $view_data['can_create_members'] = get_array_value($permissions, "can_create_members");
            $view_data['can_edit_members'] = get_array_value($permissions, "can_edit_members");
    ...
    function save_permissions() {
        ...
        //Added by GS
        $can_create_task_blocks = $this->input->post('can_create_task_blocks');
        $can_edit_task_blocks = $this->input->post('can_edit_task_blocks');
        $can_delete_task_blocks = $this->input->post('can_delete_task_blocks');
        $can_create_members = $this->input->post('can_create_members');
        $can_edit_members = $this->input->post('can_edit_members');
        ...
        $permissions = array(
            ...
            //Added by GS
            "can_create_task_blocks" => $can_create_task_blocks,
            "can_edit_task_blocks" => $can_edit_task_blocks,
            "can_delete_task_blocks" => $can_delete_task_blocks,
            "can_create_members" => $can_create_members,
