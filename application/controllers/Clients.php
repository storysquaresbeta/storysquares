...
$custom_fields =array();
       // $this->access_only_allowed_members();
        ...
        $clients = $this->Projects_model->get_project_clients($project_query)->result();
       
            $clients_query = array();
            if(count($clients) > 0){
                foreach($clients as $client){
                    $clients_query[] = $client->client_id;
                }
            }
...
//Edited by GS
    ...
    private function _make_row2($data, $custom_fields) {
